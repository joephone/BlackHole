package com.transcendence.gallery.recyclerView;
...
public class GalleryRecyclerView extends RecyclerView {
     ...
     * 设置adapter
     */
    public GalleryRecyclerView setDataAdapter(Adapter adapter) {
     ...
     * 设置横向或者竖向，注意需要限制传入类型
     */
    public GalleryRecyclerView setOrientation(@Orientation int orientation){
