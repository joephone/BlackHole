...
public class ImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            boolean isLocked = savedInstanceState.getBoolean(ConstantsLibGallery.IS_LOCKED, false);
    ...
    private int getPosition() {
        return getArguments().getInt(ConstantsLibGallery.POSITION);
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        if (isViewPagerActive()) {
            outState.putBoolean(ConstantsLibGallery.IS_LOCKED, viewPager.isLocked());
        }
