package com.transcendence.core.ui.alertview;
...
public class AlertView {
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            View itemView = LayoutInflater.from(context).inflate(R.layout.layout_alertview_item_alertbutton, null);
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.text_33));
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                if (i != 0){
                    ...
                    divier.setBackgroundColor(context.getResources().getColor(R.color.line));
