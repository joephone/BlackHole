package com.transcendence.core.ui.rv.linkage.defaults;
/*
...
public class DefaultLinkageSecondaryAdapterConfig
  ...
  public int getGridLayoutId() {
    return R.layout.ui_rv_linkpage_default_adapter_secondary_grid;
  }

  @Override
  public int getLinearLayoutId() {
    return R.layout.ui_rv_linkpage_default_adapter_secondary_linear;
  }
  ...
  public int getFooterLayoutId() {
    return R.layout.ui_rv_linkpage_default_adapter_secondary_footer;
  }
  ...
  public void onBindFooterViewHolder(LinkageSecondaryFooterViewHolder holder,
                                     BaseGroupedItem<DefaultGroupedItem.ItemInfo> item) {
    ((TextView) holder.getView(R.id.tv_secondary_footer)).setText("THE END");
