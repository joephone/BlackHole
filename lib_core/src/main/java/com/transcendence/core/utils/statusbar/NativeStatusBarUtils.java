...
public class NativeStatusBarUtils {

    private Activity mActivity;

    public NativeStatusBarUtils(Activity mActivity) {
        this.mActivity = mActivity;
    }

    public static NativeStatusBarUtils with(Activity activity) {
        return new NativeStatusBarUtils(activity);
    }
