...
import com.transcendence.douya.R;
...
public class ViewUtils {
    ...
    public static void fadeOut(@NonNull final View view, int duration,final boolean gone,
                               @Nullable final Runnable nextRunnable) {
    ...
    public static void hideTextInputLayoutErrorOnTextChange(
            @NonNull EditText editText, @NonNull final TextInputLayout textInputLayout) {
    ...
    public static void postOnDrawerClosed(@NonNull final DrawerLayout drawerLayout,
