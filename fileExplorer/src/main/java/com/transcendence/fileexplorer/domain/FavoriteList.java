...
package com.transcendence.fileexplorer.domain;
...
import com.transcendence.fileexplorer.adapter.FavoriteListAdapter;
...
import com.transcendence.fileexplorer.utils.IntentBuilder;
...
public class FavoriteList implements FavoriteDatabaseHelper.FavoriteDatabaseListener {
    ...
    public FavoriteList(Context context, ListView list, FavoriteDatabaseHelper.FavoriteDatabaseListener listener,
