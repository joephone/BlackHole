...
import com.transcendence.fileexplorer.adapter.FileListAdapter;
...
import com.transcendence.fileexplorer.utils.ActivitiesManager;
import com.transcendence.fileexplorer.utils.FileViewInteractionHub;
import com.transcendence.fileexplorer.utils.Settings;
...
/**
 * @Author Joephone on 2021/7/8 0008 下午 5:35
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(action)
            ...
            if (!pickFolder) {
                ...
                mRootView.findViewById(R.id.button_pick_confirm).setOnClickListener(new View.OnClickListener() {
                ...
                mRootView.findViewById(R.id.button_pick_cancel).setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        mActivity.finish();
                    }
                });
