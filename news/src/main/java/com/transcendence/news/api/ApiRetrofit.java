...
import com.transcendence.news.base.app.NewsApplication;
import com.transcendence.news.utils.NetWorkUtils;
...
public class ApiRetrofit {
    ...
    private Interceptor mCacheInterceptor = chain -> {
        ...
        if (!NetWorkUtils.isNetworkAvailable(NewsApplication.getContext())) {
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(NewsApplication.getContext().getCacheDir(), "responses");
