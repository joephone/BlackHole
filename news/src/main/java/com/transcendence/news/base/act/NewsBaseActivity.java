...
import com.transcendence.news.listener.PermissionListener;
...
/**
 * @Author Joephone on 2020/3/17 16:39
...
public abstract class NewsBaseActivity <T extends NewsBasePresenter>  extends AppCompatActivity {
    ...
    public final void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivity = NewsBaseActivity.this;
        if (enableSlideClose()) {
    ...
    public int getSlideLayoutType() {
        return ParallaxBackLayout.LAYOUT_COVER;
    }
    ...
    public void onBackPressed() {
        if (mCurrentActivity instanceof NewsMainActivity){
            //如果是主页面
