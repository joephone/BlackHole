...
import com.transcendence.ui.recyclerview.swiperecyclerview.footerView.SimpleFooterView;
...
public class SwipeRecyclerView extends FrameLayout
    ...
    private void setupSwipeRecyclerView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.swiperecyclerview_layout_swipe_recyclerview, this);
