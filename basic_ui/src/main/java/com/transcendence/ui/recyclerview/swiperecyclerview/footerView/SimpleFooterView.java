package com.transcendence.ui.recyclerview.swiperecyclerview.footerView;
...
public class SimpleFooterView extends BaseFooterView{
    ...
    public SimpleFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.swiperecyclerview_layout_footer_view, this);
