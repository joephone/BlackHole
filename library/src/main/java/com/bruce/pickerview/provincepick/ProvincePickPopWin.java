...
import com.bruce.pickerview.view.PickerView;
import com.bruce.pickerview.view.PickerItem;
import com.bruce.pickerview.provincepick.utils.ProvinceInfoParserTask;
...
public class ProvincePickPopWin extends PopupWindow implements OnClickListener, PickerView.OnPickedListener {
	...
	private void init() {
		...
		contentView = LayoutInflater.from(mContext).inflate(R.layout.loopview_date_picker, null);
