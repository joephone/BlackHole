...
package com.transcendence.blackhole.widget.custom.scroll.lfscroll;
 ...
 */
public class LfScrollLayout extends FrameLayout {
    ...
    public LfScrollLayout(Context context) {
        super(context);
    }

    public LfScrollLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initFromAttributes(context, attrs);
    }

    public LfScrollLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private final RecyclerView.OnScrollListener recyclerViewOnScrollListener
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (mLayoutManager instanceof LinearLayoutManager){
                ...
                L.d("------visibleItemCount:"+visibleItemCount
                        +"--totalItemCount:"+totalItemCount+"---pastVisiblesItems:"+pastVisiblesItems);
                if (totalItemCount>0&&pastVisiblesItems==1){
                    isTop = true;
                }else {
                    isTop = false;
                }
...
//                }
//            };
    private void updateListViewScrollState(RecyclerView recyclerView) {
        L.d("----isTop--"+isTop);
