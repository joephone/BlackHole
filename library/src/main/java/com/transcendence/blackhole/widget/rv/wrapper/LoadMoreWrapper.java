package com.transcendence.blackhole.widget.rv.wrapper;
...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_FOOTER) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.layout_rv_loading_footer, parent, false);
            ...
            switch (mLoadingState) {
                case LOADING: // Loading
                    if (mLoadingView != null) {
                        ...
                        View loadingView = View.inflate(mContext, R.layout.layout_rv_loading, null);
                ...
                case LOADING_END: // Loading end
                    if (mLoadingEndView != null) {
                        ...
                        View loadingEndView = View.inflate(mContext, R.layout.layout_rv_loading_end, null);
