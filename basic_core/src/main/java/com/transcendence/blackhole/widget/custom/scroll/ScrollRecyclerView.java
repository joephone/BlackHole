package com.transcendence.blackhole.widget.custom.scroll;
...
public class ScrollRecyclerView extends RecyclerView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                lastY = eY;
                L.d("liuyzz:recyclerview:"+canScroll+"-isTop:"+isTop()+"-offset:"+offset);
    ...
    private boolean isTop() {
        ...
        L.d("liuyzz:recyclerview:" + "position:"+visibleItemPosition+"-top:"+childView.getTop());
        //坐标系 下正右正
