...
package com.transcendence.core.widget.custom.scroll.lfscroll.content;
...
import com.transcendence.core.widget.custom.scroll.lfscroll.LfScrollLayout;
...
public class ContentScrollView extends ScrollView {
    ...
    protected void onAttachedToWindow() {
        ...
        while (parent != null) {
            if (parent instanceof ScrollLayout) {
                ((LfScrollLayout) parent).setAssociatedScrollView(this);
                break;
            }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ViewParent parent = this.getParent();
        if (parent instanceof ScrollLayout) {
            if (((LfScrollLayout) parent).getCurrentStatus() == LfScrollLayout.Status.OPENED){
                return false;
            }
        }
