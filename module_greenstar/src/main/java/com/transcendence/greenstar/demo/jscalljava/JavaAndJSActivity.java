...
/**
 * @author joephone
 * @date 2025/4/25 19:45
 * @description java和js互调
 * @edition 1.0
 */
public class JavaAndJSActivity extends AppAc implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_demo_jscalljava_java_and_js;
    }
