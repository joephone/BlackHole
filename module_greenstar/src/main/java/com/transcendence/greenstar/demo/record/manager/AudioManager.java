...
public class AudioManager {
    ...
    public void prepareAudio() {
        try {
            ...
            isPrepared = false;
            //创建所属文件夹
            LogUtils.d("mDirString---"+mDirString);
            ...
            LogUtils.d("mCurrentFilePathString---"+mCurrentFilePathString);
            ...
            // 已经准备好了，可以录制了
            if (mListener != null) {
                LogUtils.d("mListener != null---wellPrepared");
    ...
    private String generalFileName() {
        LogUtils.d("generalFileName---"+UUID.randomUUID().toString() + ".amr");
    ...
    public void release() {
        ...
        * 这里处理一些特定情况下的异常。2017/04/12 by wgyscsf
        ...
        try {
            ...
            LogUtils.e( Log.getStackTraceString(e) + "123");
