package com.transcendence.greenstar.demo.record.manager;
...
import com.transcendence.greenstar.demo.record.utils.FileUtils;
...
public class AudioRecordButton extends AppCompatButton
    ...
    private Runnable mGetVoiceLevelRunnable = new Runnable() {
        ...
        @Override
        public void run() {
            LogUtils.d("mGetVoiceLevelRunnable run");
            while (isRecording) {
                try {
                    //最长mMaxRecordTimes
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                LogUtils.d("mReady---"+mReady);
                LogUtils.d("isRecording---"+isRecording);
                LogUtils.d("mTime---"+mTime);
                LogUtils.d("STATE_RECORDING---"+STATE_RECORDING);
                if (!mReady) {
                    reset();
