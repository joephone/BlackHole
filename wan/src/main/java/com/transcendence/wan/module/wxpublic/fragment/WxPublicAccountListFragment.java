...
public class WxPublicAccountListFragment extends Fragment {
     ...
     */
    public static WxPublicAccountListFragment newInstance(String title) {
        WxPublicAccountListFragment fragment = new WxPublicAccountListFragment();
