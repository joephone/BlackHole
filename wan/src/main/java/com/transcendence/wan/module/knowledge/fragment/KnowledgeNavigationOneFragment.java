...
public class KnowledgeNavigationOneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView =  inflater.inflate(R.layout.fragment_knowledge_navi_one, container, false);
        initView(rootView);
        return rootView;
    }
     ...
     */
    public static KnowledgeNavigationOneFragment newInstance(String title) {
        KnowledgeNavigationOneFragment fragment = new KnowledgeNavigationOneFragment();
