...
final class PermissionSettingPage {
    ...
    static Intent getSmartPermissionIntent(Context context, List<String> deniedPermissions) {
        ...
        if (PermissionUtils.isAndroid11() && deniedPermissions.size() == 3 &&
                (deniedPermissions.contains(PermissionPool.MANAGE_EXTERNAL_STORAGE) &&
                        deniedPermissions.contains(PermissionPool.READ_EXTERNAL_STORAGE) &&
                        deniedPermissions.contains(PermissionPool.WRITE_EXTERNAL_STORAGE))) {
