 ...
 * @EditionHistory
 */
public class ScrollLayoutLiuF extends FrameLayout {
    ...
    public ScrollLayoutLiuF(Context context) {
        super(context);
    }

    public ScrollLayoutLiuF(Context context, AttributeSet attrs) {
        super(context, attrs);
        initFromAttributes(context, attrs);
    }

    public ScrollLayoutLiuF(Context context, AttributeSet attrs, int defStyle) {
