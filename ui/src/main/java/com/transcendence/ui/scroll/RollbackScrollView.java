...
/**
 * @Author: Created by He on 2017/12/19.
 * @Description:
 */
...
public class RollbackScrollView extends ScrollView {
    ...
    private OnRollBackListener listener;
    //------尾部收缩属性end--------
    public RollbackScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(deltaY>=50 && listener!=null && !upDownSlide){
                    listener.onRefresh();
                }
                if (!isCount) {
                    deltaY = 0; // 在这里要归0.
    ...
    public void setListener(OnRollBackListener listener) {
