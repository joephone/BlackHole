//package com.transcendence.freeland.ui.gallery.adp;
//
...
//        return new JbottomHoldView(mLayoutInflater.inflate(R.layout.activity_ui_gallary_z_main_bottom_item, parent, false));
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
//        final JbottomHoldView holder = (JbottomHoldView) viewHolder;
//        GlideWrapper.getInstance().loadImageFromLocal(mIvList[position],holder.iv);
