package com.transcendence.blackhole.ui.scroll.personalscroll.view;
...
public class PullScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PersonalScrollView);

            if (ta != null) {
                mHeaderHeight = (int) ta.getDimension(R.styleable.PersonalScrollView_headerHeight, -1);
                mHeaderVisibleHeight = (int) ta.getDimension(R.styleable
                        .PersonalScrollView_headerVisibleHeight, -1);
                ta.recycle();
            }
        }
    }
