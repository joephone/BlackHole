...
public class SwipeRecyclerViewMainActivity extends TitleBarActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_ui_rv_swiperecyclerview_demo_activity_main;
    }
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(SwipeRecyclerViewMainActivity.this).inflate(R.layout.activity_ui_rv_swiperecyclerview_demo_layout_item, parent, false);
        ...
        public void onBindViewHolder(final ItemViewHolder holder, final int position) {
            ...
            holder.tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(SwipeRecyclerViewMainActivity.this, "快来咬我啊，我是" + position + "号", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
