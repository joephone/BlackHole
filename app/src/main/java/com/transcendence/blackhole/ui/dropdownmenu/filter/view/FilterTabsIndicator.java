package com.transcendence.blackhole.ui.dropdownmenu.filter.view;
...
import com.transcendence.blackhole.ui.dropdownmenu.filter.adapter.MenuAdapter;
import com.transcendence.blackhole.ui.dropdownmenu.filter.util.DpUtils;
...
public class FilterTabsIndicator extends LinearLayout {
    ...
    private View generateTextView(String title, int pos) {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.dropdownmenu_level_filter);//设置箭头方向
