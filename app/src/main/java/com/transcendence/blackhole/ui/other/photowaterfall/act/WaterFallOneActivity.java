package com.transcendence.blackhole.ui.other.photowaterfall.act;
...
import com.transcendence.blackhole.ui.other.photowaterfall.view.ImageLoaderTask;
import com.transcendence.blackhole.ui.other.photowaterfall.view.LazyScrollView;
import com.transcendence.blackhole.ui.other.photowaterfall.view.TaskParam;
...
public class WaterFallOneActivity extends TitleBarActivity {
	...
	public int getLayoutId() {
		return R.layout.activity_other_waterfall_one;
	}
	...
	private void AddImage(String filename, int columnIndex) {
		ImageView item = (ImageView) LayoutInflater.from(this).inflate(
				R.layout.activity_other_waterfall_one_item, null);
