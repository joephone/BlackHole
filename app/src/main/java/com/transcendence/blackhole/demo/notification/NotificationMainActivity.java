 ...
 */
public class NotificationMainActivity extends TitleBarActivity {
    private static final String TAG = NotificationMainActivity.class.getSimpleName();
    ...
    protected int getLayoutId() {
        return R.layout.activity_demo_notification_main;
    }
    ...
    public void sendNotification(int id, String title) {
        ...
        switch (id) {
            case NOTI_PRIMARY1:
                nb = noti.getNotification1(NotificationMainActivity.this,title, getString(R.string.primary1_body));
                break;

            case NOTI_PRIMARY2:
                nb = noti.getNotification1(NotificationMainActivity.this,title, getString(R.string.primary2_body));
                break;

            case NOTI_SECONDARY1:
                nb = noti.getNotification2(NotificationMainActivity.this,title, getString(R.string.secondary1_body));
                break;

            case NOTI_SECONDARY2:
                nb = noti.getNotification2(NotificationMainActivity.this,title, getString(R.string.secondary2_body));
                break;
        }
        if (nb != null) {
            noti.notify(id, nb);
