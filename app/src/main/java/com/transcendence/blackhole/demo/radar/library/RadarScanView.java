package com.transcendence.blackhole.demo.radar.library;
...
public class RadarScanView extends View {
    ...
    private int circleColor = Color.parseColor("#FF0000");   //#a2a2a2
    private int radarColor = Color.parseColor("#FF0000");    //#99a2a2a2
    private int tailColor = Color.parseColor("#4c90f9");    //#50aaaaaa
