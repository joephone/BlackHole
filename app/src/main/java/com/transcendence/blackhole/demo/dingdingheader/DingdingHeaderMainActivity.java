package com.transcendence.blackhole.demo.dingdingheader;
...
public class DingdingHeaderMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_dingding_main);
        ...
        DingDingScrollView mainScrollView = (DingDingScrollView) findViewById(R.id.sv_main_scroll_view);
        mainScrollView.setOnScrollChangedListener(new DingDingScrollView.OnScrollChangedListener() {
            @Override
