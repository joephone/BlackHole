...
public class FileSelectorMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_other_file_selector_main);
        ...
        PermissionCheckUtils.setOnOnWantToOpenPermissionListener(new PermissionCheckUtils.OnWantToOpenPermissionListener() {
            ...
            public void onWantToOpenPermission() {
                Toast.makeText(FileSelectorMainActivity.this, "请去设置的应用管理中打开应用读取内存的权限", Toast.LENGTH_SHORT).show();
            }
        });
    }
