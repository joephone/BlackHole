package com.transcendence.blackhole.demo.loopview;
...
//    private String mCity = null; // 城市
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_loopview_main);
...
//        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        findViewById(R.id.date).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerPopWin pickerPopWin = new DatePickerPopWin.Builder(LoopViewActivity.this, new DatePickerPopWin.OnDatePickedListener() {
                    @Override
                    public void onDatePickCompleted(int year, int month, int day, String dateDesc) {
                        Toast.makeText(LoopViewActivity.this, dateDesc, Toast.LENGTH_SHORT).show();
                    }
                        ...
                        .build();
                pickerPopWin.showPopWin(LoopViewActivity.this);
            }
        });
        ...
        findViewById(R.id.timepick).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerPopWin timePickerPopWin=new TimePickerPopWin.Builder(LoopViewActivity.this, new TimePickerPopWin.OnTimePickListener() {
                    @Override
                    public void onTimePickCompleted(int hour, int minute, String AM_PM, String time) {
                        Toast.makeText(LoopViewActivity.this, time, Toast.LENGTH_SHORT).show();
                    }
                }).textConfirm("CONFIRM")
                        .textCancel("CANCEL")
                        .btnTextSize(16)
                        ...
                        .build();
                timePickerPopWin.showPopWin(LoopViewActivity.this);
            }
        });
        ...
        findViewById(R.id.province).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(LoopViewActivity.this, "Working on...", Toast.LENGTH_SHORT).show();
