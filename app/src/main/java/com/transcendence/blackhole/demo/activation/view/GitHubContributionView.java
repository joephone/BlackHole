package com.transcendence.blackhole.demo.activation.view;
...
/**
 * @author Joephone on 2019/8/27 11:30
...
public class GitHubContributionView extends View {
    ...
    public void initView() {
        ...
        //将默认值转换px
        padding = ScreenUtils.dp2px(getContext(), padding);
        boxSide = ScreenUtils.dp2px(getContext(), boxSide);
