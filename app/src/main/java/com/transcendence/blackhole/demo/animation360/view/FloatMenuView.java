package com.transcendence.blackhole.demo.animation360.view;
...
import com.transcendence.blackhole.demo.animation360.activity.FloatViewManager;
...
public class FloatMenuView extends LinearLayout {
    ...
    private void init() {
        View view =View.inflate(getContext(), R.layout.activity_demo_float_view_float_menuview,null);
