package com.transcendence.blackhole.demo.lottery.view.luckyboard;
...
public class LuckyBoard extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private void parseAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        backgroundId = ta.getResourceId(R.styleable.LuckyBoard_background, R.mipmap.luckyboard_timg);
        blockBackgroundId = ta.getResourceId(R.styleable.LuckyBoard_blockBackground, R.mipmap.luckyboard_timg);
        if (backgroundId != 0) {
